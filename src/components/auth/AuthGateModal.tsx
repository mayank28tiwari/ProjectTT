...
import { AUTH_PROVIDERS, AUTH_BENEFITS } from "./providers";
...
export function AuthGateModal({ open, onOpenChange }: AuthGateModalProps) {
    ...
    const availableProviders = AUTH_PROVIDERS.filter(p => p.available);
            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription className="text-center text-muted-foreground pt-2">
                        It&apos;ll take less than you blink your eyes 5 times. Bet?
                    </DialogDescription>
                </DialogHeader>
